...
> Organized by CTF challenge type — only the most practical tools and resources.
...
| ctf-tools | One-command CTF tool installer | https://github.com/zardus/ctf-tools |
| Ciphey | AI-powered automatic decryption | https://github.com/ciphey/ciphey |
| CyberChef | Online encode/decode + crypto | https://gchq.github.io/CyberChef/ |
...
### Common Topics
- Algorithm reconstruction (crypto / encoding / custom)
- Anti-debug / anti-VM bypass
- Packing / obfuscation (UPX / VMProtect / OLLVM)
...
### Common Topics
- Memory dump analysis (processes / credentials / malware)
...
| HackTheBox | Hands-on machines | https://www.hackthebox.com/ |
