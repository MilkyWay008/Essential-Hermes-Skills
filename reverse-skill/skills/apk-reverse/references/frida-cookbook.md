...
> Curated from open-source projects such as [awesome-frida](https://github.com/dweinstein/awesome-frida), [Frida-Mobile-Scripts](https://github.com/m0bilesecurity/Frida-Mobile-Scripts), [frida-codeshare-scripts](https://github.com/zengfr/frida-codeshare-scripts).
...
| frida-codeshare-scripts | the most complete script collection | https://github.com/zengfr/frida-codeshare-scripts |
