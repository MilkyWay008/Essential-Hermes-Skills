# Crypto / Encoding & Decoding Tools Quick Reference

> Reverse engineering and CTF work frequently involves encrypted/encoded/hashed data. This document lists the most practical tools by scenario.

---

## Auto-Detection + Decryption (when the encryption is unknown)
...
| Tool | Use | Link |
|------|------|------|
| **RsaCtfTool** | Automated RSA attacks (20+ attack modes) | https://github.com/Ganapati/RsaCtfTool |
| **SageMath** | Mathematical computing (integer factorization/elliptic curves) | https://www.sagemath.org/ |
| **factordb.com** | Online integer factorization lookup | http://factordb.com/ |
| **yafu** | Local integer factorization | https://github.com/bbuhrow/yafu |
...
## Identifying Crypto in Reverse Engineering
...
| 16-byte blocks + multiple substitution rounds | AES |
...
1. Look at the length and character set
   ...
   - 32/40/64-char hex → hash (MD5/SHA1/SHA256)
...
7. If it is traditional ZIP encryption → prefer `bkcrack` known-plaintext attack; don't brute-force passwords without evidence first

8. If it is custom encryption → reverse the algorithm with IDA/Ghidra → write a custom decryption script
```
